...
![dotfiles-logo](https://github.com/Linkyrex/dotfiles/assets/46715299/6c1d626d-28d2-41e3-bde5-981d9bf93462)
<p align="center">
    <a href="https://github.com/Linkyrex/dotfiles/actions/workflows/ansible-lint.yml"><img align="center" src="https://github.com/Linkyrex/dotfiles/actions/workflows/ansible-lint.yml/badge.svg"/></a>
    <a href="https://github.com/Linkyrex/dotfiles/issues"><img align="center" src="https://img.shields.io/github/issues/Linkyrex/dotfiles"/></a>
    <a href="https://github.com/sponsors/Linkyrex"><img align="center" src="https://img.shields.io/github/sponsors/Linkyrex"/></a>
    ...
    <a href="https://github.com/Linkyrex/dotfiles/commits/main"><img align="center" src="https://img.shields.io/github/commit-activity/m/Linkyrex/dotfiles" alt="commit frequency"></a>
</p>

---
Fully automated development environment for [Linkyrex](https://www.twitch.tv/Linkyrex) on Twitch.

You can watch a quick 'tour' (pre-1Password integration) here on YouTube:

<a href="https://youtu.be/hPPIScBt4Gw">
    <img src="https://github.com/Linkyrex/dotfiles/assets/46715299/b114ea0c-b67b-437b-87d3-7c7732aeccf8" alt="Automating your Dotfiles with Ansible: A Showcase" style="width:60%;"/>
</a>
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Linkyrex/dotfiles/main/bin/dotfiles)"
```

If you want to run only a specific role, you can specify the following bash command:
```bash
curl -fsSL https://raw.githubusercontent.com/Linkyrex/dotfiles/main/bin/dotfiles | bash -s -- --tags comma,seperated,tags
```
...
<a href="https://github.com/Linkyrex/dotfiles/stargazers" target="_blank" style="display: block" align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Linkyrex/dotfiles&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Linkyrex/dotfiles&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Linkyrex/dotfiles&type=Date" />
  </picture>
</a>
